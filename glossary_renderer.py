    ...
    return f"""
        <aside class="glossary-hero-form" aria-labelledby="heroFormTitle">
          ...
          <form class="custom-contact-form glossary-request-form" data-type="contact" action="https://api.web3forms.com/submit" method="POST">
            ...
            <label class="glossary-privacy-check"><input type="checkbox" name="privacy_acknowledgement" value="yes" required id="lead-1-privacy_acknowledgement"><span>I have read the <a href="privacy-policy.html" target="_blank" rel="noopener">Privacy Policy</a> and understand how my information will be used to respond to this enquiry.</span></label>
            <button type="submit" class="btn-submit specialization-submit-btn">Request case review</button>
            <div class="form-msg" role="status" aria-live="polite" aria-atomic="true"></div>
          </form>
        </aside>"""
...
{form}
  ...
  <script src="navigation.js?v=20260925-contact1"></script>
  <script src="specialization-form.js?v=20260925-measure1"></script>
  <!-- ── FLOATING WHATSAPP ── -->
